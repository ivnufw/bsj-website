...
// =======================================================
$staff_group = 'ภาษาต่างประเทศ'; // ** เปลี่ยนตรงนี้: ชื่อกลุ่มใน DB **
$staff_group_title = 'กลุ่มสาระการเรียนรู้ภาษาต่างประเทศ';
$staff_color_primary = '#800080'; // Purple
$staff_color_secondary = '#FAF0E6'; // Linen (พื้นหลัง)
$staff_color_accent = '#EE82EE'; // Violet Accent
...
<main class="container my-5">
    <div class="thai-staff-section">
        ...
        <h2 class="thai-staff-header display-5 mb-5"><i class="fas fa-language me-3"></i> <?php echo $staff_group_title; ?></h2>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-white" style="background-color: <?php echo $staff_color_primary; ?>;">
                <h5 class="modal-title" id="staffEditModalLabel"><i class="fas fa-user-edit me-1"></i> เพิ่ม/แก้ไข บุคลากรกลุ่มสาระภาษาต่างประเทศ</h5>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8">
                            <label for="full-name-th" class="form-label">ชื่อ-นามสกุล (ไทย/อังกฤษ) <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="position-th" name="position_th" required>
                            ...
                            <option value="หัวหน้ากลุ่มสาระการเรียนรู้ภาษาต่างประเทศ">หัวหน้ากลุ่มสาระการเรียนรู้ภาษาต่างประเทศ</option>
        ...
        if (staffEditModal) {
            staffEditModal.addEventListener('show.bs.modal', function (event) {
                ...
                if (staffId > 0) {
                    ...
                    // Add Mode
                    staffEditModal.querySelector('.modal-title').textContent = 'เพิ่มบุคลากรกลุ่มสาระภาษาต่างประเทศ';
