...
// =======================================================
$staff_group = 'ภาษาไทย'; // ** เปลี่ยนตรงนี้: ชื่อกลุ่มใน DB **
$staff_group_title = 'กลุ่มสาระการเรียนรู้ภาษาไทย';
$staff_color_primary = '#8B0000'; // Dark Red
$staff_color_secondary = '#FFF5EE'; // SeaShell (พื้นหลัง)
$staff_color_accent = '#DAA520'; // Gold Accent
...
<main class="container my-5">
    <div class="thai-staff-section">
        ...
        <h2 class="thai-staff-header display-5 mb-5"><i class="fas fa-feather-alt me-3"></i> <?php echo $staff_group_title; ?></h2>
        ...
        <?php if (!empty($staff_list)): ?>
            ...
            <?php 
            // 1. หัวหน้ากลุ่มสาระ (First Staff Member based on sort_order)
            ...
            <?php 
            // 2. บุคลากรคนอื่น ๆ (Starting from the second member)
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-white" style="background-color: <?php echo $staff_color_primary; ?>;">
                <h5 class="modal-title" id="staffEditModalLabel"><i class="fas fa-user-edit me-1"></i> เพิ่ม/แก้ไข บุคลากรกลุ่มสาระภาษาไทย</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="position-th" name="position_th" required>
                            ...
                            <option value="หัวหน้ากลุ่มสาระการเรียนรู้ภาษาไทย">หัวหน้ากลุ่มสาระการเรียนรู้ภาษาไทย</option>
        ...
        if (staffEditModal) {
            staffEditModal.addEventListener('show.bs.modal', function (event) {
                ...
                if (staffId > 0) {
                    ...
                    // Add Mode
                    staffEditModal.querySelector('.modal-title').textContent = 'เพิ่มบุคลากรกลุ่มสาระภาษาไทย';
