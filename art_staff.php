...
// =======================================================
$staff_group = 'ศิลปะ ดนตรี นาฏศิลป์'; // ** เปลี่ยนตรงนี้: ชื่อกลุ่มใน DB **
$staff_group_title = 'กลุ่มสาระการเรียนรู้ศิลปะ ดนตรี นาฏศิลป์';
$staff_color_primary = '#FF1493'; // Deep Pink
$staff_color_secondary = '#FFF0F5'; // Lavender Blush (พื้นหลัง)
$staff_color_accent = '#FFB6C1'; // Light Pink Accent
...
<main class="container my-5">
    <div class="thai-staff-section">
        ...
        <h2 class="thai-staff-header display-5 mb-5"><i class="fas fa-music me-3"></i> <?php echo $staff_group_title; ?></h2>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-white" style="background-color: <?php echo $staff_color_primary; ?>;">
                <h5 class="modal-title" id="staffEditModalLabel"><i class="fas fa-user-edit me-1"></i> เพิ่ม/แก้ไข บุคลากรกลุ่มสาระศิลปะ ดนตรี นาฏศิลป์</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="position-th" name="position_th" required>
                            ...
                            <option value="หัวหน้ากลุ่มสาระการเรียนรู้ศิลปะ ดนตรี นาฏศิลป์">หัวหน้ากลุ่มสาระการเรียนรู้ศิลปะ ดนตรี นาฏศิลป์</option>
        ...
        if (staffEditModal) {
            staffEditModal.addEventListener('show.bs.modal', function (event) {
                ...
                if (staffId > 0) {
                    ...
                    // Add Mode
                    staffEditModal.querySelector('.modal-title').textContent = 'เพิ่มบุคลากรกลุ่มสาระศิลปะ ดนตรี นาฏศิลป์';
